...
void interpolation(void)
{
	...
	KeyFrame[playIndex].RlegsInc = (KeyFrame[playIndex + 1].Rlegs - KeyFrame[playIndex].RlegsInc) / i_max_steps;
...
void Animation() {
	...
	if (play)
	{
		...
		else
		{
			...
			RLegs += KeyFrame[playIndex].Rlegs;
...
// Ejercicio: Mover las patas y la cola del perro como con la cabeza.