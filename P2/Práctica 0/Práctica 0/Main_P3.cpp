...
//void crearCirculo{
//	model = glm::mat4(1);
//	model = glm::translate(model, glm::vec3(6.0f, -3.0f, .0f));
//	model = glm::rotate(model, 0.5f, glm::vec3(.0f, 10.0f, 5.0f));
//	model = glm::scale(model, glm::vec3(5.0f, 0.3f, 1.0f));
...
int main() {
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.0f, 4.0f, .0f));
		model = glm::rotate(model, 0.5f, glm::vec3(.0f, 1.0f, .0f));
