...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        GLint lightPosLoc2 = glGetUniformLocation(lightingShader.Program, "light.position1");
        glUniform3f(lightPosLoc2, lightPos1.x + movelightPos1, lightPos1.y + movelightPos1, lightPos1.z + movelightPos1);
        ...
        glUniformMatrix4fv(glGetUniformLocation(lampshader.Program, "view"), 1, GL_FALSE, glm::value_ptr(view));
        model = glm::mat4(1.0f);
        model = glm::translate(model, lightPos1 + movelightPos1);
        model = glm::scale(model, glm::vec3(0.3f));
        glUniformMatrix4fv(glGetUniformLocation(lampshader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        glBindVertexArray(VAO);
        red_dog.Draw(lightingShader);
