...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[0].diffuse"), 0.5f, 0.0f, 0.5f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[1].diffuse"), 0.0f, 0.7f, 1.0f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[3].diffuse"), 1.0f, 0.5f, 0.0f);
		...
		glUniform1f(glGetUniformLocation(lightingShader.Program, "spotLight.quadratic"), 0.3f);
		...
		//Ejercicio: Mover las luces puntuales a la esquina del piso y que cada una muestre diferentes colores de luz
